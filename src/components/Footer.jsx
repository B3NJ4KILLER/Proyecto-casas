      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
          ...
          <div>
            ...
            {/* Íconos sociales (Facebook, Instagram, WhatsApp, Gmail) */}
            <div className="flex space-x-4">
              {/* Facebook */}
              <a
              ...
              {/* Gmail / Email */}
              <a
                href="mailto:contacto@vistapropiedades.cl"
                className="w-10 h-10 rounded-full bg-gray-800 flex items-center justify-center hover:bg-yellow-500 hover:text-gray-900 transition duration-300"
              >
                <svg
                  className="w-5 h-5"
            ...
            <ul className="space-y-4">
              <li className="flex items-start">
                ...
                <span className="text-gray-400">
                  ...
                  Copiapó, Caldera y Región de Atacama.
                </span>
              </li>
              <li className="flex items-start">
                <svg
              ...
              <li className="flex items-center">
                ...
                <span className="text-gray-400">+56 9 9224 5912</span>
              </li>
              <li className="flex items-center">
                <svg
                  className="w-6 h-6 text-yellow-500 mr-3"
                ...
                <span className="text-gray-400">nelly.v9@gmail.com</span>
              </li>
            </ul>
          </div>
        </div>
